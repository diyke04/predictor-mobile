...
const CustomButton: React.FC<CustomButtonProps> = ({ title, onPress,accessible,accessibilityRole }) => {
  return (
    <View className='w-full px-4 py-2 bg-color1 text-white rounded-md hover:bg-color2 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'>
